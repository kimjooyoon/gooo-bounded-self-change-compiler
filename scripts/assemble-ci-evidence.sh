...
cp "$report" "$stage_root/evidence/decision-dossier.json"
cp "$human_report" "$stage_root/evidence/human-report.md"
cp "$conformance_work/first/semantic-ir.json" "$stage_root/evidence/semantic-ir.json"
cp "$conformance_work/first/semantic-graph.json" "$stage_root/evidence/semantic-graph.json"
cp "$conformance_work/first/candidate.gooo" "$stage_root/evidence/candidate.gooo"
cp "$conformance_work/first/candidate.go" "$stage_root/evidence/candidate.go"
cp "$conformance_work/first/proposal.patch.json" "$stage_root/evidence/proposal.patch.json"
...
cp "$output" "$stage_root/evidence/ci-evidence.json"
