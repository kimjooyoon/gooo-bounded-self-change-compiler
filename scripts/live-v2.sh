...
jq -n \
	...
	--argjson asset "$asset" \
	'{schema:"gooo/bounded-self-change/execution/v2",scenario:"deterministic-safe-self-improvement",mode:"live",source_digest:$source_digest,meta_digest:$meta_digest,contract_digest:$contract_digest,ir_digest:$ir_digest,candidate_digest:"",toolchain:"not-run",runner:"ubuntu-latest",observations:[],before_after:{},stage_measurements:{},indicators:[],same_scope:false,same_job:false,positive_work:false,repository_writes:0,remote_writes:0,local_test_executions:0,cross_project_required_gates:0,integration_state:"STOPPED",live_ledger:{lock:{id:"SELF_IMPROVEMENT_LEDGER_V0_50",repository:"kimjooyoon/gooo-self-improvement-ledger",tag:"v0.50.0",release_id:380866481,immutable:true,tag_object_sha:"9e3263ea902bef64fa31c05ca7c1ab038ef962ef",target_sha:"e93768f4204e8a88214026ffa22febad7ecedcbd",asset_name:$asset.name,asset_id:$asset.id,asset_size_bytes:$asset.size,asset_digest:$asset.digest},actionable_frontier:"EXTERNAL_UTILITY_EVIDENCE",automation_can_produce:false,external_evidence:true,decision:"UNKNOWN"}}' > "$work/execution-live.json"
